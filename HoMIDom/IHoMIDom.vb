...
#Region "Device"
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        <OperationContract()> Function ExistDeviceById(ByVal DeviceId As String) As Boolean
        ...
        ''' <remarks></remarks>
        <OperationContract()> Function ReturnDeviceByDriver(ByVal IdSrv As String, ByVal DriverID As String, ByVal Enable As Boolean) As ArrayList
        ...
        ''' <returns>List de device, Nothing si non trouvé ou ID du serveur erroné</returns>
        ''' <remarks></remarks>
        <OperationContract()> Function ReturnDeviceByZoneType(ByVal IdSrv As String, ByVal ZoneID As String, ByVal DeviceType As String, ByVal Enable As Boolean) As ArrayList
...
#Region "Zone"
        ...
        ''' <remarks></remarks>
        <OperationContract()> Function GetDeviceInZone(ByVal IdSrv As String, ByVal zoneId As String) As List(Of String) 'TemplateDevice)
...
#Region "Macro"
        ...
        ''' <remarks></remarks>
        <OperationContract(), ServiceKnownType(GetType(HoMIDom.Macro)), ServiceKnownType(GetType(HoMIDom.Action.ActionDevice)), ServiceKnownType(GetType(HoMIDom.Action.ActionDriver)), ServiceKnownType(GetType(HoMIDom.Action.ActionMail)), ServiceKnownType(GetType(HoMIDom.Action.ActionIf)), ServiceKnownType(GetType(HoMIDom.Action.ActionMacro)), ServiceKnownType(GetType(HoMIDom.Action.ActionSpeech)), ServiceKnownType(GetType(HoMIDom.Action.ActionHttp)), ServiceKnownType(GetType(HoMIDom.Action.ActionLogEvent)), ServiceKnownType(GetType(HoMIDom.Action.ActionLogEventHomidom)), ServiceKnownType(GetType(HoMIDom.Action.ActionDos)), ServiceKnownType(GetType(HoMIDom.Action.ActionVB)), ServiceKnownType(GetType(HoMIDom.Action.ActionSTOP)), ServiceKnownType(GetType(HoMIDom.Action.ActionVar))> Function GetAllMacros(ByVal IdSrv As String) As List(Of Macro)
        ...
        ''' <remarks></remarks>
        <OperationContract(), ServiceKnownType(GetType(HoMIDom.Macro)), ServiceKnownType(GetType(HoMIDom.Action.ActionDevice)), ServiceKnownType(GetType(HoMIDom.Action.ActionDriver)), ServiceKnownType(GetType(HoMIDom.Action.ActionMail)), ServiceKnownType(GetType(HoMIDom.Action.ActionIf)), ServiceKnownType(GetType(HoMIDom.Action.ActionMacro)), ServiceKnownType(GetType(HoMIDom.Action.ActionSpeech)), ServiceKnownType(GetType(HoMIDom.Action.ActionHttp)), ServiceKnownType(GetType(HoMIDom.Action.ActionLogEvent)), ServiceKnownType(GetType(HoMIDom.Action.ActionLogEventHomidom)), ServiceKnownType(GetType(HoMIDom.Action.ActionDos)), ServiceKnownType(GetType(HoMIDom.Action.ActionVB)), ServiceKnownType(GetType(HoMIDom.Action.ActionSTOP)), ServiceKnownType(GetType(HoMIDom.Action.ActionVar))> Function ReturnMacroById(ByVal IdSrv As String, ByVal MacroId As String) As Macro
        ...
        ''' <remarks></remarks>
        <OperationContract(), ServiceKnownType(GetType(HoMIDom.Macro)), ServiceKnownType(GetType(HoMIDom.Action.ActionDevice)), ServiceKnownType(GetType(HoMIDom.Action.ActionDriver)), ServiceKnownType(GetType(HoMIDom.Action.ActionMail)), ServiceKnownType(GetType(HoMIDom.Action.ActionIf)), ServiceKnownType(GetType(HoMIDom.Action.ActionMacro)), ServiceKnownType(GetType(HoMIDom.Action.ActionSpeech)), ServiceKnownType(GetType(HoMIDom.Action.ActionHttp)), ServiceKnownType(GetType(HoMIDom.Action.ActionLogEvent)), ServiceKnownType(GetType(HoMIDom.Action.ActionLogEventHomidom)), ServiceKnownType(GetType(HoMIDom.Action.ActionDos)), ServiceKnownType(GetType(HoMIDom.Action.ActionVB)), ServiceKnownType(GetType(HoMIDom.Action.ActionSTOP)), ServiceKnownType(GetType(HoMIDom.Action.ActionVar))> Function SaveMacro(ByVal IdSrv As String, ByVal macroId As String, ByVal nom As String, ByVal enable As Boolean, Optional ByVal description As String = "", Optional ByVal listactions As ArrayList = Nothing) As String
#End Region
...
#Region "Decouverte"
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        <OperationContract()> Function AddDetectNewDevice(ByVal Adresse1 As String, ByVal DriverId As String, Optional ByVal Type As String = "", Optional ByVal Adresse2 As String = "", Optional ByVal Value As String = "") As String
